...
1. Run `microasm` to build the µcode ROM and decoder ROM images used by the CPU:
      * `uROM-[0-5].bin` - µcode routines to executed by the *control unit* to orchestrate the operation of the CPU.
...
1. Configure the `digital` circuit emulation application to use the built µcode and decoder ROMs.
   ...
   * Configure the decoder ROMs
      * Right click on the *Instruction Decoder* and select "Open Circuit".
         ...
         * Set the *File* value to the location of the `mModeDecoder.bin` built above.
         * Clock `OK` to close the dialog.
         * Right click on *p2 (OpCode)* ROM and select the *Advanced* tab.
         * Set the *File* value to the location of the `mOpDecoder.bin` built above.
      ...
      * Right click on the *Control Unit* and select "Open Circuit".
         ...
         * Set the *File* value to the appropriate `uROM-[0-5].bin` built above.
         * Click `OK` to close the dialog.
