...
namespace MicroAsm
{
    ...
    public class MicroOps
    {
        ...
        public MicroOps(MicroCtrl uCtrl, string sourceFile, int wordSizeBytes)
        {
            _uCtrl = uCtrl;
            _sourceFile = sourceFile;
            _wordSizeBytes = wordSizeBytes;
        ...
        {
            var ucopsParts = line.Split(SPLIT_CHARS, StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries);
